        ...
        <tr>
            ...
            <td class="auto-style14">
               &nbsp;<br />
                ...
                <asp:CustomValidator ID="CustomValidator1" runat="server" ErrorMessage="from date not valid" OnServerValidate="CustomValidator1_ServerValidate" ControlToValidate="txtFromDate"></asp:CustomValidator>
            </td>
